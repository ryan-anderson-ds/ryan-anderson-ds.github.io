---
layout: post
title: A broad exploration of why AI is a (useful) bubble
type: insights
---
...
- **Long term skills:** If none of us learn how to code from first principles, none of us can effectively understand why code built by AI is broken. All entry level engineers are now using (or being replaced by) AI - but will they ever become high level engineers if they cannot actually code the things they are automating the coding of? Or are we going to see two tiers of workers - those who just use AI, and those who go through the effort to fix the output thereof?
...
Be cautious of promises that sound too good. Ask what real, measurable value AI brings - today, not in theory.
